...
app.directive('beaverChosen', function(){
    return {
        scope: {
            showAttribute: "@",
            modelAttribute: "@",
        ...
        templateUrl: "global/beaverChosen.tpl.html",
        link: function (scope, element, attr)
        {
            scope.selectedObj = {};
            scope.$watch('selectedObj', function(elem){
                if(elem)
                {
                    if(scope.modelAttribute && scope.modelAttribute in elem)
                    {
                        scope.objModel = elem[scope.modelAttribute];
                    }
                }
            });

            //initialize
            scope.$watch('objModel', function(elem){
                if(elem)
                {
                    scope.objList.forEach(function(obj){
                        if(obj[scope.modelAttribute] == elem)
                        {
