...
(function(module) {
    ...
    module.init = function(beaver) {
        ...
        mongodb.MongoClient.connect('mongodb://'+ beaver.config.adapters.Mongo.host + ':' +  beaver.config.adapters.Mongo.port + '/' +  beaver.config.adapters.Mongo.db, function(err, _db) {
            if(err) {
