//include lodash first before this files
(function(_)
{
    ...
    Object.defineProperty(STRPROTO, 'possessiveize', {
        enumerable: false,
        value: function() {
            if (isPlural(this) && endsWithS(this)) return this + "'";
            return this + "'s";
        }
    });

    function isPlural(str) {
        return str === str.pluralize();
    }

    function endsWithS(str) {
        return str.slice(-1)[0] === 's';
    }
